...
DROP TABLE tbcliente; # Comando para apagar tabela

DROP TABLE tbproduto; # Comando para apagar tabela
...
ALTER TABLE tbcliente ADD PRIMARY KEY (CPF); # alterar uma propriedade de uma tabela que já existe.

CREATE TABLE tbproduto # Comando para criar tabela 
(PRODUTO VARCHAR (20) ,
NOME VARCHAR (150) ,
...
ALTER TABLE tbproduto ADD PRIMARY KEY (PRODUTO); # alterar uma propriedade de uma tabela que já existe.
